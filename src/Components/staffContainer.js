...
const SERVER_ADDRESS = `/owner/bars/${BAR_ID}/staff`;
...
class StaffContainer extends Component {
  ...
  onSubmit = (e) => {
    ...
    this.setState({ newStaffMember: { name, email } });
    return 0;
  }
  ...
  onConfirm = async (e) => {
    ...
    if (!newStaffMember) {
      alert('Error: Please ensure that you submit a new staff member.'); // eslint-disable-line no-alert
      return 1;
    }
